...
HD_PWD='C:/Users/zwk/Desktop/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log new_keypad.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source new_keypad.tcl
