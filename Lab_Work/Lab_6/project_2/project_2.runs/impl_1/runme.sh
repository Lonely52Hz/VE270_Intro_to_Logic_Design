...
HD_PWD='C:/Users/zwk/Desktop/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log new_keypad.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source new_keypad.tcl -notrace
